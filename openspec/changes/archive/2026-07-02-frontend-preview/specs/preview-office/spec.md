# preview-office — OnlyOffice 集成规格
...
#### Scenario: API JS 加载
- **WHEN** OfficePreview 页面加载
- **THEN** 系统从环境变量 `VITE_ONLYOFFICE_API_URL` 获取 OnlyOffice Document Server 地址，动态加载 `<script src="{VITE_ONLYOFFICE_API_URL}/web-apps/apps/api/documents/api.js"></script>`
